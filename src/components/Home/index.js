...
class Home extends Component {
  ...
  renderCountryCaronaCases = () => {
    ...
    return (
      <div className="country-cases-card">
        <div className="cases-card" data-testid="countryWideConfirmedCases">
        ...
        <div className="cases-card" data-testid="countryWideActiveCases">
        ...
        <div className="cases-card" data-testid="countryWideRecoveredCases">
        ...
        <div className="cases-card" data-testid="countryWideDeceasedCases">
  ...
  renderStateWiseCard = () => {
    ...
    return (
      <div
        className="state-wise-cases-card"
          ...
          <div className="table-head-column-card">
            ...
            <div className="sort-btn-card">
              <button
                ...
                aria-label="Sort states in ascending order"
              ...
              <button
                ...
                aria-label="Sort states in descending order"
  ...
  renderSearchQueries = () => {
    ...
    const searchQueries = statesList.filter(each =>
      each.state_name.toLowerCase().includes(searchInput.toLowerCase()),
    )

    return (
      <ul
        className="search-quires-list"
        data-testid="searchResultsUnorderedList"
      >
        {searchQueries.map(each => (
          <SearchResultItem
            item={each}
            key={each.state_code}
            isLastChild={
              searchQueries.indexOf(each) === searchQueries.length - 1
            }
          />
        ))}
      </ul>
